    ...
    <div className="bg-white dark:bg-slate-950 w-full relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            <div className="lg:col-span-7 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-10 sm:mb-14 animate-fade-in-up delay-300">
                <Link href="/projects" className="w-full sm:w-auto bg-slate-950 dark:bg-white text-white dark:text-slate-950 px-8 py-4 rounded-xl font-bold text-sm hover:bg-indigo-600 dark:hover:bg-indigo-50 transition-all flex items-center justify-center gap-2 group shadow-xl active:scale-95">
                  View Registry
                  <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link href="/contact" className="w-full sm:w-auto bg-white dark:bg-slate-900 text-slate-950 dark:text-white border border-slate-200 dark:border-white/10 px-8 py-4 rounded-xl font-bold text-sm hover:border-indigo-200 hover:bg-indigo-50/30 transition-all text-center active:scale-95">
                  Start Conversation
                </Link>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 pb-8 sm:pb-12">
            {featuredPreview.map((project, idx) => (
              <Link key={project.id} href="/projects" className={`group block animate-fade-in-up delay-${(idx + 1) * 100} relative hover:z-20`}>
      ...
      <section className="py-20 sm:py-32 bg-white dark:bg-slate-950 text-center relative overflow-hidden">
        <div className="max-w-3xl mx-auto px-6 sm:px-10 animate-reveal-scale relative z-10">
          ...
          <Link href="/contact" className="w-full sm:w-auto inline-flex px-12 py-5 bg-slate-950 dark:bg-white text-white dark:text-slate-950 rounded-xl font-black text-[11px] uppercase tracking-widest hover:bg-indigo-600 dark:hover:bg-indigo-50 transition-all shadow-xl hover:scale-105 active:scale-95">
            Initiate Protocol
          </Link>
        </div>
      </section>
